...
String id;
String provider_id,category_id,title,avatar,price,status,deleted,coppyright,artist_name,album_name,file_mp4,date_published,youtube_url,download_status;
